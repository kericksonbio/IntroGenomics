...
This class has code modified from the Data Carpentry's introduction to the shell tutorial, which can be found here: <https://datacarpentry.github.io/shell-genomics/01-introduction.html>. This tutorial is also modified from previous tutorials compiled by Serena Caplins (<https://baylab.github.io/MarineGenomics/>) and Maddie Armstrong (<https://baylab.github.io/IntroGenomics/>)

## Learning Objectives
-   Assess current knowledge by taking the Pre-class assessment (link on syllabus)
-   Understand relevance of genomics & shell computing to personal goals and interests (via slideshow here: [Week 1 Slides](./figs/W1_introcoding.pdf))
-   Access the terminal via Farm OnDemand
-   Practice interacting with the command line interface to move around in your file system
...
<https://canvas.ucdavis.edu/courses/1061172/files?preview=29704214>
...
If you cannot access the folder on farm, you can download the activity to your computer,
but be sure to use the command line rather than your computer's GUI to find the files!
[Download Week 1 Activity](./docs/week1_activity.zip)
