...
genomics methods you've used. Most of the package we use have names that
match their module names, but cutadapt is a bit different. 
To load cutadapt and check the version, type:
...
> ## Class Exercise 1
>
> 1. Load all both packages and check their versions.
> 
